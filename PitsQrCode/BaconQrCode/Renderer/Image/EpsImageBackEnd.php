...
namespace PitsQrCode\BaconQrCode\Renderer\Image;

use PitsQrCode\BaconQrCode\Exception\RuntimeException;
use PitsQrCode\BaconQrCode\Renderer\Color\Alpha;
use PitsQrCode\BaconQrCode\Renderer\Color\Cmyk;
use PitsQrCode\BaconQrCode\Renderer\Color\ColorInterface;
use PitsQrCode\BaconQrCode\Renderer\Color\Gray;
use PitsQrCode\BaconQrCode\Renderer\Color\Rgb;
use PitsQrCode\BaconQrCode\Renderer\Path\Close;
use PitsQrCode\BaconQrCode\Renderer\Path\Curve;
use PitsQrCode\BaconQrCode\Renderer\Path\EllipticArc;
use PitsQrCode\BaconQrCode\Renderer\Path\Line;
use PitsQrCode\BaconQrCode\Renderer\Path\Move;
use PitsQrCode\BaconQrCode\Renderer\Path\Path;
use PitsQrCode\BaconQrCode\Renderer\RendererStyle\Gradient;
use PitsQrCode\BaconQrCode\Renderer\RendererStyle\GradientType;
...
final class EpsImageBackEnd implements ImageBackEndInterface
{
    ...
    public function new(int $size, ColorInterface $backgroundColor) : void
    {
        $this->eps = "%!PS-Adobe-3.0 EPSF-3.0\n"
            . "%%Creator: PitsQrCode\BaconQrCode\n"
