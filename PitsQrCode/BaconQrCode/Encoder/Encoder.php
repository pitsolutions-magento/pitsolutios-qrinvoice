...
namespace PitsQrCode\BaconQrCode\Encoder;

use PitsQrCode\BaconQrCode\Common\BitArray;
use PitsQrCode\BaconQrCode\Common\CharacterSetEci;
use PitsQrCode\BaconQrCode\Common\ErrorCorrectionLevel;
use PitsQrCode\BaconQrCode\Common\Mode;
use PitsQrCode\BaconQrCode\Common\ReedSolomonCodec;
use PitsQrCode\BaconQrCode\Common\Version;
use PitsQrCode\BaconQrCode\Exception\WriterException;
use SplFixedArray;
