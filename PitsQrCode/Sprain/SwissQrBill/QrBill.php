...
namespace PitsQrCode\Sprain\SwissQrBill;

use PitsQrCode\Endroid\QrCode\ErrorCorrectionLevel;
use PitsQrCode\Sprain\SwissQrBill\Constraint\ValidCreditorInformationPaymentReferenceCombination;
use PitsQrCode\Sprain\SwissQrBill\DataGroup\AddressInterface;
use PitsQrCode\Sprain\SwissQrBill\DataGroup\Element\AdditionalInformation;
use PitsQrCode\Sprain\SwissQrBill\DataGroup\Element\AlternativeScheme;
use PitsQrCode\Sprain\SwissQrBill\DataGroup\Element\CreditorInformation;
use PitsQrCode\Sprain\SwissQrBill\DataGroup\Element\Header;
use PitsQrCode\Sprain\SwissQrBill\DataGroup\Element\PaymentAmountInformation;
use PitsQrCode\Sprain\SwissQrBill\DataGroup\Element\PaymentReference;
use PitsQrCode\Sprain\SwissQrBill\DataGroup\Element\StructuredAddress;
use PitsQrCode\Sprain\SwissQrBill\DataGroup\QrCodeableInterface;
use PitsQrCode\Sprain\SwissQrBill\Exception\InvalidQrBillDataException;
use PitsQrCode\Sprain\SwissQrBill\QrCode\QrCode;
use PitsQrCode\Sprain\SwissQrBill\String\StringModifier;
...
class QrBill implements SelfValidatableInterface
{
    ...
    public function getQrCode(): QrCode
    {
        ...
        $qrCode->setRoundBlockSize(true, \PitsQrCode\Endroid\QrCode\QrCode::ROUND_BLOCK_SIZE_MODE_ENLARGE);
        $qrCode->setMargin(0);
