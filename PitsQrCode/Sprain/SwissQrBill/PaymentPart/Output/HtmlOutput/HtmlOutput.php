...
namespace PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\HtmlOutput;

use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\AbstractOutput;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\Element\OutputElementInterface;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\Element\Placeholder;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\Element\Text;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\Element\Title;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\HtmlOutput\Template\PlaceholderElementTemplate;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\HtmlOutput\Template\PrintableStylesTemplate;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\HtmlOutput\Template\TextElementTemplate;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\HtmlOutput\Template\PaymentPartTemplate;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\HtmlOutput\Template\TitleElementTemplate;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Output\OutputInterface;
use PitsQrCode\Sprain\SwissQrBill\PaymentPart\Translation\Translation;
